...
void GameScene::Update()
{
	...
	if (TriggerTimer <= 10 && TriggerFlag == false)
	{
		TriggerTimer += 1;
	}
	...
	case 1:
		...
		////コントローラでステージ回転
		//if (IsButtonUp(ButtonKind::Button_Y) || IsButtonUp(ButtonKind::Button_X))
		//{
		//	if (IsButtonUp(ButtonKind::Button_Y))
		//	{
		//		if (cameraMove == 4)
		//		{
		//			prevCameraMove = cameraMove;
		...
		//	else if (IsButtonUp(ButtonKind::Button_X))
		//	{
		//		if (cameraMove == 0)
		//		{
		//			prevCameraMove = cameraMove;
		...
		//コントローラでステージ回転
		if (IsButtonPush(ButtonKind::Button_LB) || IsButtonPush(ButtonKind::Button_RB) && TriggerFlag == true)
		{
			//assert(0);
			if (IsButtonPush(ButtonKind::Button_LB) && TriggerFlag == true)
			{
				if (cameraMove == 1)
				{
					prevCameraMove = cameraMove;
			...
			if (IsButtonPush(ButtonKind::Button_RB) && TriggerFlag == true)
			{
				if (cameraMove == 1)
				{
					prevCameraMove = cameraMove;
