...
void Stage1::Update()
{
	...
	if (beginStage)
	{
		...
		////コントローラでステージ回転
		//if (IsButtonUp(ButtonKind::Button_LB) || IsButtonUp(ButtonKind::Button_RB))
		//{
		//	if (IsButtonUp(ButtonKind::Button_LB))
		//	{
		//		if (cameraMove == 4)
		//		{
		//			prevCameraMove = cameraMove;
		...
		//	else if (IsButtonUp(ButtonKind::Button_RB))
		//	{
		//		if (cameraMove == 0)
		//		{
		//			prevCameraMove = cameraMove;
		...
		//if (IsButtonPush(ButtonKind::Button_Y))
		//{
		//	//assert(0);
		//}
